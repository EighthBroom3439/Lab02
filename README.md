...
Цель данной лабораторной работы заключалась в том, чтобы ознакомиться с базовыми приемами для работы с системой контроля версий GitБ изучить основные операции и получить навыки организации С++
